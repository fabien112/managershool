                            ...
                            <div class="box-body wizard-content">
                                ...
                                <section>
                                    ...
                                    <Upload multiple type="drag" action="api/admin/upload" :on-success="handleSuccess"
                                        :on-error="handleError" :format="['jpg', 'jpeg', 'png']" :max-size="2048"
                                        :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" :headers="{
                                            'X-Requested-With':
                                                'XMLHttpRequest'
                                        }">
                                    ...
                                    <Modal title="Image" v-model="visible">
                                        <img :src="`/Photos/Logos/${data.imageLogo}`
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control required" v-model.trim="data.nomAdmin
                                                    " />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control required" v-model.trim="data.PrenomAdmin
                                                    " />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control required" v-model="data.emailAdmin
                                                    " />
                                                <!-- <span class="text-danger mt-2" v-if="(!$v.data.emailAdmin
                                                        .required ||
                                                        !$v.data
                                                            .emailAdmin
                                                            .email) &&
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control required" v-model.trim="data.matricule
                                                    " />
                                        ...
                                        <div class="col-md-6">
                                            <button @click="onSubmit" class="btn btn-facebook">Modifier </button>
...
export default {
    ...
    async mounted() {
        ...
        if (localStorage.Teacherdata) {
            ...
            console.log("Le sexe du prof", this.data.sexe)
            ...
            this.data.sexe = this.Teacherdata.sexe.trim()
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            if (this.data.nomAdmin == '') {
                this.w('Veillez remplir le nom ')

            } else if (this.data.PrenomAdmin == '') {
                this.w('Veillez remplir le prenom ')
            } else if (this.data.sexe == '') {
                this.w('Veillez remplir le sexe')
            }
